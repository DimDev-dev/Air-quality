...
async function getPollutionData(){
  try {
    const response = await fetch("http://api.airvisual.com/v2/nearest_city?key=b35098e9-cc15-4f56-8fee-559c80dcebab").catch(error => {
...
function populateUI(data){
  ...
  userInformation.textContent = `La situation dans ${data.city}.`;
